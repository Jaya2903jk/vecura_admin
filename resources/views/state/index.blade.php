        ...
        <div class="content">
                            ...
                            <tbody>
                                @forelse($states as $i => $state)
                                    <tr>
                                        ...
                                        <td><span
                                                class="badge badge-soft-info border border-info">{{ $state->state_code }}</span>
                                        </td>
                                                ...
                                                <ul class="dropdown-menu p-2">
                                                    ...
                                                    <li>
                                                        <a href="#" class="dropdown-item delete-btn"
                                                            data-id="{{ $state->state_id }}"
                                                            data-name="{{ $state->state_name }}" data-bs-toggle="modal"
            ...
            <div class="table-footer-bar d-flex justify-content-between align-items-center mt-2">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>Showing {{ $states->firstItem() }} to {{ $states->lastItem() }} of {{ $states->total() }}
                        entries</div>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="state_code" class="form-control text-uppercase"
                                        maxlength="10" placeholder="e.g. TN">
                                </div>
                    ...
                    <form id="editForm">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">State Code <span class="text-danger">*</span></label>
                                    <input type="text" name="state_code" id="edit_state_code"
