...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-3 pb-3 border-bottom">
            <div class="flex-grow-1">
                <h4 class="fw-bold mb-0">State Master
                        ...
                        <tbody>
                            @forelse($states as $i => $state)
                                <tr>
                                    ...
                                    <td><span class="badge badge-soft-info border border-info">{{ $state->state_code }}</span></td>
        ...
        <div class="table-footer-bar d-flex justify-content-between align-items-center mt-2">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>Showing {{ $states->firstItem() }} to {{ $states->lastItem() }} of {{ $states->total() }} entries</div>
            </div>
        </div>
        <div class="pagination-box">
            {{ $states->appends(['per_page' => $perPage])->links('pagination::bootstrap-5') }}
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="text-dark modal-title fw-bold">Add New State</h4>
                ...
                <form id="addForm">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="state_code" class="form-control text-uppercase" maxlength="10" placeholder="e.g. TN">
                            </div>
                    ...
                    <div class="modal-footer d-flex align-items-center gap-1">
                        ...
                        <button type="submit" id="addSubmitBtn" class="btn btn-primary">Add State</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="edit_modal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="text-dark modal-title fw-bold">Edit State</h4>
                    <button type="button" class="btn-close btn-close-modal custom-btn-close" data-bs-dismiss="modal" aria-label="Close"><i class="ti ti-x"></i></button>
                </div>
                <form id="editForm">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label">State Code <span class="text-danger">*</span></label>
                                <input type="text" name="state_code" id="edit_state_code" class="form-control text-uppercase" maxlength="10">
                            </div>
                            <div class="col-md-8 mb-3">
                                <label class="form-label">State Name <span class="text-danger">*</span></label>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#addForm').on('submit', function (e) {
            ...
            $.ajax({
                url: "{{ route('state.store') }}", type: 'POST',
                ...
                error: function (xhr) { btn.prop('disabled', false).text('Add State'); handleFormError(xhr, '#addForm'); }
            });
        });
