        ...
        <div class="content">
            ...
            <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-3 pb-3 border-bottom">
                <div class="flex-grow-1">
                    <h4 class="fw-bold mb-0">Role<span
                            class="badge badge-soft-primary border border-primary page-header-badge ms-2">Total Roles :
                            6</span></h4>
                </div>
                <div class="text-end d-flex">
                    ...
                    <a href="javascript:void(0);" class="btn btn-primary ms-2 fs-13 btn-md" data-bs-toggle="modal"
                        data-bs-target="#add_modal"><i class="ti ti-plus me-1"></i>Add New Role</a>
                </div>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="text-dark modal-title fw-bold">Add New Role</h4>
                ...
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content">
                        <div class="modal-body text-center">
                            ...
                            <p class="mb-3">Are you sure you want to delete this role record?</p>
