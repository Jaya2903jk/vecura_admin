...
@section('content')
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-3 pb-3 border-bottom">
                <div class="flex-grow-1">
                    <h4 class="fw-bold mb-0">Permission<span
                            class="badge badge-soft-primary border border-primary page-header-badge ms-2">Total Permissions :
                            10</span></h4>
                </div>
                <div class="text-end d-flex">
                    ...
                    <a href="javascript:void(0);" class="btn btn-primary ms-2 fs-13 btn-md" data-bs-toggle="modal"
                        data-bs-target="#add_modal"><i class="ti ti-plus me-1"></i>Add New Permission</a>
                </div>
            </div>
                        ...
                        <table class="table datatable mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>Create Staff</td>
                                    <td>Staff</td>
                                    <td>Allows user to create staff records</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>Department</td>
                                    <td>Allows user to update departments</td>
                                    <td>
                                        <div class="action-item">
                                            <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                                <i class="ti ti-dots-vertical"></i>
                                ...
                                <tr>
                                    <td>View Branch</td>
                                    <td>Branch</td>
                                    <td>Allows user to view branch details</td>
                                    <td>
                                        <div class="action-item">
                                            <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                                <i class="ti ti-dots-vertical"></i>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="text-dark modal-title fw-bold">Add New Permission</h4>
                ...
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content">
                        <div class="modal-body text-center">
                            ...
                            <p class="mb-3">Are you sure you want to delete this permission record?</p>
        ...
        <div class="footer text-center bg-white p-2 border-top">
            <p class="text-dark mb-0">2026 &copy; <a href="javascript:void(0);" class="link-primary">Vecura</a>, All
                Rights Reserved</p>
        </div>
    </div>
