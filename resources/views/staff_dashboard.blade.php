                        ...
                        <div class="card shadow-sm flex-fill w-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center gap-2 flex-wrap mb-3">
                                    ...
                                    <p class="mb-0 d-inline-flex align-items-center"><i
                                            class="ti ti-clock text-dark me-1"></i>06:30 PM </p>
                                </div>
                                <div class="row">
                                    <div class="col">
                        ...
                        <div class="card shadow-sm flex-fill w-100">
                            ...
                            <div class="card-body pb-0">
                                <div class="d-flex align-items-center justify-content-end gap-2 mb-1 flex-wrap mb-3">
                                    ...
                                    <p class="mb-0 d-inline-flex align-items-center"><i
                                            class="ti ti-point-filled me-1 fs-18 text-success"></i>Completed Appointments
                                    </p>
                                </div>
                                                    ...
                                                    <ul class="dropdown-menu p-2">
                                                        <li>
                                                            <a href="javascript:void(0);"
                                                                ...
                                                                data-bs-target="#edit_appointment"><i
                        ...
                        <div class="card shadow-sm flex-fill w-100">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                                    ...
                                    <p class="mb-0 d-inline-flex align-items-center"><i class="ti ti-clock me-1"></i>11:00
                                        PM - 12:30 PM</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
