        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="{{ url('index') }}" class="logo">
                ...
                <span class="logo-light">
                    ...
                    <span class="logo-sm"><img src="{{ URL::asset('build/img/logo-small.svg') }}"
                            alt="small logo"></span>
                </span>

                <!-- Logo Dark -->
                <span class="logo-dark">
                    <span class="logo-lg"><img src="{{ URL::asset('build/img/logo-white.svg') }}"
                            alt="dark logo"></span>
                </span>
            </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="{{ url('new-appointment') }}" class="btn topbar-link"><i
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <a href="{{ url('profile-settings') }}" class="btn topbar-link"><i
                ...
                @livewire('ticket-notification') <!-- Notification Dropdown -->
                {{-- <div class="header-item">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="mb-1 text-wrap">
                                                booked an appointment with <span class="fw-medium text-dark">Dr.
                                                    Patel</span> for <span class="fw-medium text-dark">April 15</span>
                                            </p>
                                            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                    <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative"
                        ...
                        <img src="{{ URL::asset('build/img/users/user-01.jpg') }}" width="32"
