                ...
                <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('kanban-view') }}"
                                            class="{{ Request::is('kanban-view') ? 'active' : '' }}">Kanban Board</a>
                                    </li>
                                    ...
                                    <li><a href="{{ url('search-list') }}"
                                            class="{{ Request::is('search-list') ? 'active' : '' }}">Search Result</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('layout-mini', 'layout-hover-view', 'layout-hidden', 'layout-full-width', 'layout-rtl', 'layout-dark') ? 'active subdrop' : '' }}">
                                    <i class="ti ti-layout-sidebar"></i><span>Layouts</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul>
                                    <li><a href="{{ url('index') }}"
                                            class="{{ Request::is('index') ? 'active' : '' }}">Default</a></li>
                                    <li><a href="{{ url('layout-mini') }}"
                                            class="{{ Request::is('layout-mini') ? 'active' : '' }}">Mini</a></li>
                                    <li><a href="{{ url('layout-hover-view') }}"
                                            class="{{ Request::is('layout-hover-view') ? 'active' : '' }}">Hover
                                            View</a></li>
                                    <li><a href="{{ url('layout-hidden') }}"
                                            class="{{ Request::is('layout-hidden') ? 'active' : '' }}">Hidden</a></li>
                    ...
                    <li>
                        <ul>
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('add-doctor') }}"
                                            class="{{ Request::is('add-doctor') ? 'active' : '' }}">Add Doctor</a>
                                    </li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('patients', 'patients-grid', 'edit-patient', 'patient-details', 'create-patient') ? 'active subdrop' : '' }}">
                                    <i class="ti ti-user-heart"></i><span>Patients</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul>
                                    <li><a href="{{ url('patients') }}"
                                            class="{{ Request::is('patients', 'edit-patient', 'patients-grid') ? 'active' : '' }}">Patients</a>
                                    </li>
                                    <li><a href="{{ url('patient-details') }}"
                                            class="{{ Request::is('patient-details') ? 'active' : '' }}">Patient
                                            Details</a></li>
                                    <li><a href="{{ url('create-patient') }}"
                                            class="{{ Request::is('create-patient') ? 'active' : '' }}">Create
                                            Patient</a></li>
                                </ul>
                            </li>
                            <li class="submenu">
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="{{ url('leaves') }}"
                                            class="{{ Request::is('leaves') ? 'active' : '' }}">Leaves</a></li>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="{{ url('invoices') }}"
                                            class="{{ Request::is('invoices') ? 'active' : '' }}">Invoices</a></li>
                    ...
                    <li>
                        <ul>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('roles-and-permissions', 'permissions', 'delete-account-request') ? 'active subdrop' : '' }}">
                                    <i class="ti ti-user"></i><span>Users</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul>
                                    <li><a href="{{ url('roles-and-permissions') }}"
                                            class="{{ Request::is('roles-and-permissions', 'permissions') ? 'active' : '' }}">Roles
                                            & Permissions</a></li>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="{{ url('add-blog') }}"
                                            class="{{ Request::is('add-blog') ? 'active' : '' }}">Add Blog</a></li>
                                    <li><a href="{{ url('blogs') }}"
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('ui-ratio') }}"
                                            class="{{ Request::is('ui-ratio') ? 'active' : '' }}">Ratio</a></li>
                                    ...
                                    <li><a href="{{ url('ui-links') }}"
                                            class="{{ Request::is('ui-links') ? 'active' : '' }}">Links</a></li>
                                    <li><a href="{{ url('ui-list-group') }}"
                                            class="{{ Request::is('ui-list-group') ? 'active' : '' }}">List Group</a>
                                    </li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0);"><i
                                        ...
                                        class="badge bg-danger ms-2 badge-md rounded-2 fs-12 fw-medium">v1.7.0</span></a>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);">
